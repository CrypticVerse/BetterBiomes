...
public class BetterBiomesClient implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        BlockRenderLayerMap.INSTANCE.putBlock(BiomeBlocks.PALM_LEAVES, RenderLayer.getCutout());
        BlockRenderLayerMap.INSTANCE.putBlock(BiomeBlocks.PALM_SAPLING, RenderLayer.getCutout());
