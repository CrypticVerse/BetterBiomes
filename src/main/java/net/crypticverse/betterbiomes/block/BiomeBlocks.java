...
public class BiomeBlocks {
    ...
    public static void registerModBlocks() {BetterBiomes.LOGGER.info("Registering Blocks for " + BetterBiomes.REGISTRY_ID);BetterBiomes.LOGGER.info("Successfully Registered Blocks for " + BetterBiomes.REGISTRY_ID);}
