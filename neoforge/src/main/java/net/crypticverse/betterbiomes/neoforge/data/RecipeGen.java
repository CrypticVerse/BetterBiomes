...
public class RecipeGen extends RecipeProvider {
    ...
    protected void buildRecipes() {
        ...
        shaped(RecipeCategory.TRANSPORTATION, BiomeItems.HANGING_MAPLE_SIGN, 6).pattern("C C").pattern("LLL").pattern("LLL").define('L', BiomeBlocks.STRIPPED_MAPLE_LOG).define('C', Blocks.CHAIN).unlockedBy(getHasName(BiomeBlocks.STRIPPED_MAPLE_LOG),has(BiomeBlocks.STRIPPED_MAPLE_LOG)).unlockedBy(getHasName(Blocks.CHAIN), has(Blocks.CHAIN)).save(output);
