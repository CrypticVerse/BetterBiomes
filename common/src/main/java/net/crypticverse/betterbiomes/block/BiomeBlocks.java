...
public class BiomeBlocks {
    ...
    public static final Block STANDING_MAPLE_SIGN = SignBlockHelper.registerSign(Identifier.fromNamespaceAndPath(BetterBiomes.MOD_ID, "maple_sign"), settings -> new StandingSignBlock(BBWoodTypes.MAPLE_WOOD_TYPE, settings), BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_SIGN));
    public static final Block WALL_MAPLE_SIGN = SignBlockHelper.registerSign(Identifier.fromNamespaceAndPath(BetterBiomes.MOD_ID, "maple_wall_sign"), settings -> new WallSignBlock(BBWoodTypes.MAPLE_WOOD_TYPE, settings), BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_WALL_SIGN));
    public static final Block HANGING_MAPLE_SIGN = SignBlockHelper.registerSign(Identifier.fromNamespaceAndPath(BetterBiomes.MOD_ID, "maple_hanging_sign"), settings -> new CeilingHangingSignBlock(BBWoodTypes.MAPLE_WOOD_TYPE, settings), BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_HANGING_SIGN));
    public static final Block WALL_HANGING_MAPLE_SIGN = SignBlockHelper.registerSign(Identifier.fromNamespaceAndPath(BetterBiomes.MOD_ID, "maple_wall_hanging_sign"), settings -> new WallHangingSignBlock(BBWoodTypes.MAPLE_WOOD_TYPE, settings), BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_WALL_HANGING_SIGN));
    ...
    private static Block registerBlock(String name, Function<BlockBehaviour.Properties, Block> function, BlockBehaviour.Properties settings) {
        Block block = function.apply(settings.setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(BetterBiomes.MOD_ID, name))));
        registerBlockItem(name, block);
        return Registry.register(BuiltInRegistries.BLOCK, Identifier.fromNamespaceAndPath(BetterBiomes.MOD_ID, name), block);
    }
    ...
    private static void registerBlockItem(String name, Block block) {
        Registry.register(BuiltInRegistries.ITEM, Identifier.fromNamespaceAndPath(BetterBiomes.MOD_ID, name),
                new BlockItem(block, new Item.Properties().useBlockDescriptionPrefix()
                        .setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(BetterBiomes.MOD_ID, name)))));
    }
